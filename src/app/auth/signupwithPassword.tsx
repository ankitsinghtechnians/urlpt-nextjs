...
//         confirmPassword: formData.confirmpassword, // Send the hashed password
//       };
//         // debug the password
//         console.log(formData.password)
//         console.log(formData.confirmpassword)
//       // Send the POST request to the API
//       const response = await axios.post('https://urlpt.technians.in/register/', user);
...
//         console.log('API Error Response:', error.response.data); // Debugging log
...
//         <button
//           type="submit"
//           className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg hover:bg-primary p-4 font-medium text-white transition hover:bg-opacity-90 submit_btn"
//         >
//           Submit
//         </button>
//       </div>
